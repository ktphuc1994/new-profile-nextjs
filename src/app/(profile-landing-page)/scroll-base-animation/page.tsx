  ...
  return (
    <div className={styles['scroll-base-wrapper']}>
      ...
      <div className='parallax-wrapper'>
        ...
        <div className='title-wrapper'>
          ...
          <p>
            ...
            dolorem aut porro at, architecto officiis explicabo minima!
            Sapiente, quasi dolores.
          </p>
        </div>
      </div>
      <p className='text-part'>
        ...
        beatae suscipit, exercitationem aspernatur inventore animi veniam vel
        accusamus libero. Aperiam necessitatibus saepe doloribus dignissimos,
        ratione maxime, corporis sunt quasi recusandae quae animi autem aliquid
        dolore? Perferendis quaerat in ab impedit sint rerum animi consequuntur
        saepe non! Fugit explicabo sit facilis itaque optio. Dolorem, pariatur.
        Esse ratione ducimus, modi eius explicabo, soluta error reprehenderit
        dicta quidem illo placeat fuga voluptatem doloremque eaque assumenda
        aspernatur, fugit omnis similique quas! Inventore, praesentium
        doloremque nihil, sit, iste perspiciatis minus a consectetur ipsa unde
        aspernatur at odio earum.
      </p>
